...
const IMG_GATE = "https://cdn.poehali.dev/projects/f9283abc-b515-424e-949a-d4808b18b858/bucket/1ddfca4c-7757-4595-b758-1ef2d8a8141f.jpg";
...
const advantages = [
  ...
  { num: "03", title: "2–8 недель", desc: "От первого эскиза до полного монтажа — рекордные сроки без потери качества. Точно в договорённые сроки." },
          ...
          <div className="reveal">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
              {[
                ...
                { icon: "Phone", text: "+7 (996) 522-87-14", sub: "Пн–Пт: 9:00–18:00" },
